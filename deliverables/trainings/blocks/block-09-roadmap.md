# Block 9: AI Transformation planen — Vom Assessment zur Roadmap
...
> 💡 **Practice Story-Option:** "Mein erstes AI-Transformationsgespraech mit einem Kunden" — macht den Concept-Teil unmittelbar greifbar (Format: [design/konzept.md](../design/konzept.md#das-practice-story-format-10-min)).

## Concrete Practice (25 Min)

**Roadmap-Design (Team-Challenge — die grosse Abschlussuebung)**

- Szenario: Kunde hat CRAFT-Explorer-Ergebnis (vorbereitet), 4 Teams, 200 Entwickler
- Jedes Team erstellt eine 6-Zyklen-Roadmap (Mural-Template):
