# Block 2: Prompt Engineering Praxis
...
- **Myth or Fact** (Mural): 5 Aussagen zu AI-Prompts ("Laengere Prompts sind besser", "AI kann keine Tabellen", etc.)
...
**Prompt-Werkstatt (Pair Work in Breakout Rooms)**
