# Block 7: Das CRAFT-Framework verstehen
...
> 💡 **Practice Story-Option:** "Was mir CRAFT erklaert, das ich bei Kunden schon gesehen habe." Starke Boden-Verbindung fuer den abstrakten Framework-Input (Format: [design/konzept.md](../design/konzept.md#das-practice-story-format-10-min)).

## Concrete Practice (25 Min)

**Dimensions-Mapping (Team-Arbeit)**
